...
--
-- Host: 127.0.0.1
-- Generation Time: 30-Out-2018 às 02:37
...
INSERT INTO `inscricao` (`ins_codigo`, `pes_codigo`, `est_codigo`, `dis_codigo`, `log_codigo`, `ins_ensino`, `ins_descricao`, `ins_data_marcado`, `ins_hora_marcado`, `ins_dia_cadastro`, `ins_hora_cadastro`, `ins_ip`, `ins_status`) VALUES
(2, 28, 0, 8, 2, 1, '', '2018-10-29', '08:30', '30/10/2018', '00:56:13', '127.0.0.1', 2);
...
INSERT INTO `vaga` (`vag_codigo`, `log_codigo`, `est_codigo`, `dis_codigo`, `vag_quantidade`, `vag_atedia`, `vag_descricao`, `vag_status`, `vag_hora_cadastro`, `vag_dia_cadastro`, `vag_ip`) VALUES
(21, 2, 0, 8, 25, '30102018', '', 0, '02:27:34', '30/10/2018', '127.0.0.1'),
(22, 2, 0, 6, 25, '30102018', '', 0, '02:27:39', '30/10/2018', '127.0.0.1');
...
--
ALTER TABLE `cad_pessoa`
  MODIFY `pes_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `disciplina`
--
ALTER TABLE `disciplina`
  MODIFY `dis_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `inscricao`
--
ALTER TABLE `inscricao`
  MODIFY `ins_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `vaga`
  MODIFY `vag_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
ALTER TABLE `inscricao`
  ...
  ADD CONSTRAINT `inscricao_ibfk_2` FOREIGN KEY (`dis_codigo`) REFERENCES `disciplina` (`dis_codigo`),
