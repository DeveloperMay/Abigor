...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Nov-2018 às 21:58
...
INSERT INTO `login` (`log_codigo`, `esc_codigo`, `log_cpf`, `log_nome`, `log_senha`, `log_status`, `log_criacao`, `log_hora`, `log_dia`, `log_ip`, `log_group`) VALUES
(4, 1, '84167670097', 'Abigor', '89578779', 2, '', '10:44:37', '04/11/2018', '127.0.0.1', 6);
...
--
ALTER TABLE `cad_pessoa`
  MODIFY `pes_codigo` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `erro_log`
  MODIFY `err_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `escola`
--
ALTER TABLE `escola`
  MODIFY `esc_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `login`
  MODIFY `log_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
