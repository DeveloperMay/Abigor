...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Nov-2018 às 22:04
...
(1, 0, 0, 1, 1, 1, 'Matheus Maydana', '', '', '', 1, '', '', 'matheus@email.com', 0, '05/11/2018', '11:34:35', '127.0.0.1', '05/11/2018');
...
(4, 1, 6, '84167670097', 'Abigor', '89578779', 2, '11:26:46', '05/11/2018', '127.0.0.1', '05/11/2018'),
(11, 1, 4, '123456789', 'Teste Ajax', '123456789', 2, '11:34:58', '05/11/2018', '127.0.0.1', '05/11/2018'),
...
--
ALTER TABLE `cad_pessoa`
  MODIFY `pes_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `erro_log`
  MODIFY `err_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
